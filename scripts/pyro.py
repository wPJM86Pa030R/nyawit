...
if __name__ == "__main__":
    ...
    if BOT_MODE and PUBLIC_MODE:
        print("1. Di chat/group, semua member bisa pakai: /d1 /dstatus /dqueue /du /df /aria2 (/a2) /gdl (/gallerydl).")
        ...
        print("2. Public command nonaktif. Aktifkan PUBLIC_MODE=1 untuk membuka /d1 /dstatus /dqueue /du /df /aria2 /gdl.")
    elif PUBLIC_MODE:
        print("1. Di chat/group, semua member bisa pakai: /d1 /dstatus /dqueue /du /df /aria2 (/a2) /gdl (/gallerydl).")
        print("2. Untuk /d1: balas file/video ATAU link t.me lalu kirim /d1.")
        print("3. Cek antrian download: /dstatus atau /dqueue.")
    ...
    print("- Setelah /aria2 atau /gdl selesai, bot menampilkan tombol upload: Telegram / rclone GDrive / rclone Terabox")
